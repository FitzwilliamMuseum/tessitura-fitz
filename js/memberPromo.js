function memberPromo() {
    ...
    const heading = document.querySelector('.h3.tn-event-detail__ticket-selection-section-heading.tn-event-detail__ticket-selection-section-heading--ticket-selector');
