...
cc.run({
    ...
    cookie_name: 'fitz-cookies-tessitura',             // default: 'cc_cookie'
            ...
            settings_modal: {
                title: `
                    <div style="display: flex; align-items: center; gap: 32px;">
                        <span>${logo}</span>
                        <span">The Fitzwilliam Museum</span>
                    </div>
                `,
